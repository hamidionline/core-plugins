...
class channelmanagement_rentalsunited_dictionaries
{
	...
	*/
	...
	{
		$arr = array (
			"Pull_ListOTAPropTypes_RQ" => array ( "type" => 'PropertyTypes', "sub_type" => "PropertyType" , "friendly_name" => jr_gettext('_JOMRES_FRONT_TARIFFS_ROOMTYPE','_JOMRES_FRONT_TARIFFS_ROOMTYPE',false) , "jomres_type" => "ptype" , "id_attribute" => 'PropertyTypeID' ),
