...
jr_define('CHANNELMANAGEMENT_RENTALSUNITED_IMPORT_ROOM_TYPES_NOT_FOUND',"Cannot determine property room types");
...
jr_define('CHANNELMANAGEMENT_RENTALSUNITED_IMPORT_TARIFF_PRIMARY_SET',"Standard rate");
jr_define('CHANNELMANAGEMENT_RENTALSUNITED_IMPORT_TARIFF_EXTRA_SET',"Extra persons rate");