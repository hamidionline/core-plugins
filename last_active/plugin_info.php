...
class plugin_info_last_active
	...
	function __construct()
		...
		$this->data=array(
			...
			'change_log'=>'v1 Initial release. v1.1 fixed how a calculation is done to improve when the message times out. v1.2 PHP7 related maintenance. v1.3 Jomres 9.7.4 related changes v1.4 Remaining globals cleanup and jr_gettext refactor related changes. v1.5 Changed how we get the property name. v1.6 Added widget code. v1.7 Removed a check for admin area to allow scripts to call frontend menu in the administrator area. v1.8 French language file added',
			'highlight'=>'',
