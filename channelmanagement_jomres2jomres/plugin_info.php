...
class plugin_info_channelmanagement_jomres2jomres
	...
	function __construct()
		...
		$this->data=array(
			...
			"manual_link"=>'',
			'change_log'=>'v0.2 Bunches of changes regarding booking export. v0.3 Property export improvements. v0.4 Added webhook processing v0.5 Proxy header changed to use hyphens v0.6 Proxy header changed to use hyphens. Changed logging so that J2J has it\'s own log file. Queue handling moved into own class for performance. Webhook events are now base64 encoded. ',
			'highlight'=>'',
			'image'=>'',
			'demo_url'=>''
			);
