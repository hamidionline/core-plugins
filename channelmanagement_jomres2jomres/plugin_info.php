...
class plugin_info_channelmanagement_jomres2jomres
	...
	function __construct()
		...
		$this->data=array(
			...
			"manual_link"=>'',
			'change_log'=>'v0.2 Bunches of changes regarding booking export. v0.3 Property export improvements. v0.4 Added webhook processing v0.5 Proxy header changed to use hyphens',
			'highlight'=>'',
			'image'=>'',
			'demo_url'=>''
			);
