...
Flight::route('GET /cmf/property/change/log/@property_uid', function( $property_uid )
	...
	$query = 'SELECT id , property_uid , user_performing_action , channel_data , date_added , webhook_event_title ,webhook_event FROM #__jomres_webhook_events WHERE property_uid = '.$property_uid.' ORDER BY date_added DESC';
