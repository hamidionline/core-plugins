...
Flight::route('GET /cmf/property/availability/blocks/@property_uid/@start_date/@end_date', function( $property_uid , $start_date , $end_date )
	{
	...
	cmf_utilities::cache_write( $property_uid , "response" , $blocks );
	
	Flight::json( $response_name = "response" , $blocks );
	});
