...
Flight::route('GET /cmf/property/children/@property_uid', function( $property_uid )
	{
	...
	if (!isset($remote_data->children)) {
		$remote_data->children = array();
	}

	Flight::json( $response_name = "response" , $remote_data->children ); 
	});
