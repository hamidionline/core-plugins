...
class plugin_info_widget_manager_news
	...
	function __construct()
		...
		$this->data=array(
			...
			"manual_link"=>'',
			'change_log'=>'Fixed a bug where a template file was missing. v1.2 Added a feature where news articles can be targetted towards individual properties. v1.3 Improved templates. v1.4 Fixed a menu link. v1.5 CSRF hardening added. v1.6 French language file added v1.7 French lang file updated v1.8 BS4 template set added',
			'highlight'=>'',
