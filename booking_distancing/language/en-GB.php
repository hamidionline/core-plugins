...
jr_define('_JOMRES_QBLOCK_DESCRIPTION',"This setting allows you to enable booking distancing. When enabled, after every booking then a black booking is created for N days after the booking which then gives you time to ensure that the property has been deep cleaned before the next guest arrives.");
